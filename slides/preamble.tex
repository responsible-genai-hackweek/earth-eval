% hackweek_snowpack preamble — a projected 16:9 talk in the NASA theme.
%
...
\setbeamercolor{block body}{bg=nasaTintBlue, fg=black}
...
% Footline: the frame number alone, in the accent, at the right margin. No
% bar, no author/title repeat — the deck is eight slides and none of it earns
% a persistent strip.
\setbeamertemplate{footline}{%
  \hfill{\usebeamerfont{footline}\scriptsize\color{accent}\insertframenumber}%
  \hspace{0.55cm}\vskip3pt%
}
