...
reanalysis/MODSCAG comparison, use the repository skill at
...
- compare a model time other than the reviewed 15Z field without explicit
  scientific review;
- resample a model to MODIS instead of aggregating MODIS to the model grid;
