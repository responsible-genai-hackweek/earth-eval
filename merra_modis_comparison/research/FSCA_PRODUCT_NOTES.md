...
> **Provenance:** ported unchanged from the `clinton` branch (authored by Codex)
> on 2026-08-26 so that an independent implementation can be built from the same
> research. Only this note was added.
